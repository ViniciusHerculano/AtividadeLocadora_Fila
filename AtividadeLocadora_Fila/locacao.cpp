...
void locar()
{
	...
	fil = pesquisar(codigo);//Busca filme de acordo com o código informado
...
void reservar()
{
	...
	- Solicite o dia para reserva (0 Domingo 1 Segunda 2 Terca 3 Quarta 4 Quinta 5 Sexta 6 Sabado).
	  Verifique se o dia informado é válido (entre 0 e 6). Se o dia válido, armazene o dia escolhido (Fila* f = fil->dia[dia_reserva];)
